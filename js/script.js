(function($) {
	$(function() {
		...
		var puzzleData = [
				...
				{
					clue: "I recently heard this bitcoiner say that he was thinking about making a program that solo mined a single hash. If this person does that, and then he makes it open source, I'm totally going to make a UI for it that is either a slot machine or a carny game. Tag them to gauge interest in turning this great educational idea into a silly game. :)",
					answer: "supertestnet",
					position: 12,
					orientation: "across",
					startx: 1,
